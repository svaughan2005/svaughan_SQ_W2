...
The file can be run through its Github Pages link.
...
- One of the platforms changes the character's hair colour! Find and land on it to activate this.

## Assets

| File                                  | Source          |
| ------------------------------------- | --------------- |
| [3] `assets/images/ce_char_blue.webp` | pixilart.com    |
