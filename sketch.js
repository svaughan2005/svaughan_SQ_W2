...
let charD1; // character design image 1
let charD2; // character design image 2
let bgImg; // background image

let charChange;

function preload() {
  charD1 = loadImage("assets/images/ce_char_red.png");
  charD2 = loadImage("assets/images/ce_char_blue.webp");
  bgImg = loadImage("assets/images/summit_bg.jpeg");
}
...
let platforms = [
  ...
  { x: 65, y: 320, w: 120, h: 16 }, // left low platform
  { x: 280, y: 240, w: 140, h: 16 }, // centre platform
  { x: 510, y: 170, w: 120, h: 16 }, // right high platform

  { x: 160, y: 120, w: 100, h: 16 }, // THIS IS THE ONE IM CHANING // left high platform
  { x: 350, y: 320, w: 110, h: 16 }, // centre low platform

  { x: 100, y: 200, w: 130, h: 16 }, // custom platform
  { x: 570, y: 290, w: 130, h: 16 }, // far right platform
];
...
let player = {
  ...
  r: 25, // visual radius for blob drawing and collision
...
function draw() {
  // background(10);
  image(bgImg, 0, 0, 800, 450); // background image
...
function drawPlayer() {
  if (charChange) {
    image(charD2, player.x - 32, player.y - 12.5, 50, 50);
  } else {
    image(charD1, player.x - 32, player.y - 12.5, 50, 50);
  }
